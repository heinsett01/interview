            ...
            <div class="container mx-auto px-6 py-1 pb-16">
              <div class="bg-white shadow-md rounded my-6 p-5">
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input id="password" type="text" name="password" value="<?php echo e(old('password')); ?>"
                      ...
                      <div class="flex flex-col justify-cente">
                          <div class="flex flex-col">
                              <label class="inline-flex items-center mt-3">
                                  ...
                                  <?php if(count($user->roles->where('id',$role->id))): ?>
                                      checked 
                                  <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\interview\laravel-starter\resources\views/setting/user/edit.blade.php ENDPATH**/ ?>